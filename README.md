...
URLs are stored in *config.yaml* file. **LAST_URL** parameter will be rewritten after sending latest archive article.

Copy and rename *example.env* file to set your **BOT_TOKEN** and **CHAT_ID**.